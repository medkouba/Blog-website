<?php require("header.php")?>
    ...
    <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('<?php echo $article->image; ?>');">
      <div class="container">
        <div class="row same-height justify-content-center">
          <div class="col-md-12 col-lg-10">
            <div class="post-entry text-center">
              <span class="post-category text-white bg-success mb-3">Nature</span>
              <h1 class="mb-4"><a href="#"><?php echo $article->title; ?></a></h1>
              <div class="post-meta align-items-center text-center">
                <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="<?php echo $article->imageB; ?>" alt="Image" class="img-fluid"></figure>
                <span class="d-inline-block mt-1">By <?php echo $article->nameB; ?> </span>
                <span>&nbsp;-&nbsp; <?php echo $article->created; ?></span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row blog-entries element-animate">
          ...
          <div class="col-md-12 col-lg-8 main-content">
            ...
            <div class="pt-5">
              <p>Categorie:  <a href="#"><?php echo $article->name?></a>  Tags: 
              <?php 
          ...
          <div class="col-md-12 col-lg-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="bio text-center">
                <img src="<?php echo $article->imageB; ?>" alt="Image Placeholder" class="img-fluid mb-5">
                <div class="bio-body">
                  <h2><?php echo $article->nameB; ?></h2>
                  <p class="mb-4"><?php echo $article->descriptionB; ?></p>
